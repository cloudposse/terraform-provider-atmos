...
func TestComponentProcessor(t *testing.T) {
	...
	assert.Equal(t, "catalog/terraform/test-component-override-3", tenant1Ue2DevTestTestComponentDeps[4])
	assert.Equal(t, "globals/globals", tenant1Ue2DevTestTestComponentDeps[5])
	assert.Equal(t, "globals/tenant1-globals", tenant1Ue2DevTestTestComponentDeps[6])
	assert.Equal(t, "globals/ue2-globals", tenant1Ue2DevTestTestComponentDeps[7])
	...
	assert.Equal(t, "catalog/terraform/test-component-override-3", tenant1Ue2DevTestTestComponentDeps2[4])
	assert.Equal(t, "globals/globals", tenant1Ue2DevTestTestComponentDeps2[5])
	assert.Equal(t, "globals/tenant1-globals", tenant1Ue2DevTestTestComponentDeps2[6])
	assert.Equal(t, "globals/ue2-globals", tenant1Ue2DevTestTestComponentDeps2[7])
	assert.Equal(t, "tenant1/ue2/dev", tenant1Ue2DevTestTestComponentDeps2[8])
